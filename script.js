document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkAdBlocker() {
        ...
        // Check if the test ad is hidden (likely due to ad blocker)
        setTimeout(() => {
            ...
            if (adBlocked) {
                ...
                notice.className = 'ad-blocker-notice';
                notice.innerHTML = `
                    <p>Hey there! We've noticed you're using an ad blocker. We understand ads can be annoying,
                    but they help us keep Invincibdle free to play. Please consider supporting us by disabling
                    your ad blocker for this site. Thank you!</p>
                `;
    ...
    function lazyLoadAds() {
        ...
        adContainers.forEach(container => {
            ...
            // If the ad is in viewport and not already loaded, load it
            if (inViewport && !container.dataset.loaded) {
                container.dataset.loaded = true;
                
                // Find all adsbygoogle elements in this container and push them
                const adsElements = container.querySelectorAll('ins.adsbygoogle');
    ...
    // Initialize ads after the game is initialized
